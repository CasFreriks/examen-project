...
<body>
    ...
    <div class="row">
        <div class="col-md-5" style="margin:100px 0;">
        <ul class="menu-toernooi">
        ...
        <div class="col-md-7" style="margin:100px 0;">
            <div class="row">
                <div class="col-md-12">
                    <h5>Mijn toernooien</h5>
                </div>
            ...
            <div class="table-responsive">
                <table id="dataUserTable" class="table table-striped" style="width:100%">
                    ...
                    <tr>
                        ...
                        <td><a hrevf="#" class="btn btn-danger">Verlaten</a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
